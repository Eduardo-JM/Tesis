\chapter{Desarrollo experimental}
	...
	\section{Configuración experimental}
		...
		\subsection{Radiación solar de onda corta}
			...
			De las~\cref{fig:ALLSKY_SFC_SW_DWN_3d_mean_2020,ALLSKY_SFC_SW_DWN_3d_mean_2021} se observa que la irradiancia se de \acrshort{roc} de interés varía entre los \qtyrange{500}{900}{\watt\per\m\tothe{2}} y se aprecia que en mayor proporción se encuentra entre \qtyrange{600}{700}{\watt\per\m\tothe{2}} por lo que para los cálculos de operación se decide usar \qty{650}{\watt\per\m\tothe{2}} como valor de irradiancia.
	...
	%			\end{itemize}
		...
		\subsection{Definición de la alimentación}
			...
			\subsubsection{Definición del caudal}
				...
				\begin{align*}
				\dot{m} &= \dfrac{\qty{51.80\times\alpha_{\text{recibidor}}}{\watt}}{\qty{2493.97}{\kilo\joule\per\kg}}
...
%					},
					...
					note{*} = {Después de la calibración (específicamente para la bomba adquirida)}
				}
